...
namespace ExerciseSolution.Media
{
    ...
    public abstract class Medium
    {
        ...
        /// <summary>
        /// Borrow this medium. Sets the ReturnDate
        /// </summary>
        /// <param name="ua">the useraccount that borrows this medium</param>
        public void borrow(UserAccount ua)
        {
            this.borrowedTo = ua;
            this.ReturnDate.AddDays(this.Period);
        }

        /// <summary>
        /// Returns the medium
        /// </summary>
        /// <returns>returns the fee to pay, 0 if its not late</returns>
        public float returnMe()
        {
